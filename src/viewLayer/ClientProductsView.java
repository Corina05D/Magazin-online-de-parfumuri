...
public class ClientProductsView extends JFrame {
    ...
    private static String[] columnNames = new String[]{"Title", "Rating", "Volume", "Fragrance", "Intensity", "Alcohol", "Price"};
    ...
    public MenuItem getCurrentMenuItem(){
        ...
        for(MenuItem menuItem: DeliveryService.menuItems){
            if(menuItem instanceof BaseProduct){
                return new BaseProduct(title, newRating, newVolume, newFragrance, newIntensity, newAlcohol, newPrice);
            }
            if(menuItem instanceof CompositeProduct){
                return new CompositeProduct(title, newRating, newVolume,newFragrance, newIntensity, newAlcohol, newPrice);
            }
        }
        return null;
    }
